<section class="container vw-75 py-4 d-flex justify-content-center">
    <div id="#signupFormContainer" class="container mx-auto" style="width: 450px">
        <h4>註冊會員</h4>
        ...
        <div class="mx-auto p-2 mt-3">
            <form action="#" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="passwordCheck" name="passwordCheck" placeholder="請再次輸入會員密碼" required>
                </div>
                <button type="submit" class="float-right btn btn-dark" name="signup">註冊</button>
            </form>
        </div>
    </div>
</section>